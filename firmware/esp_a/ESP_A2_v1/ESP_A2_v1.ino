...
// Legacy fallback removed; active firmware uses site public Wi-Fi only.
...
const char* SENSOR_CONFIG = "A_PIR_MIC";
const char* NODE_ID = "ESP-A2";
const char* ZONE_ID = "A";
const char* WIFI_HOSTNAME = "aria-esp-a2";
...
void maintainWiFiConnection() {
  ...
  if (
    ...
    if (
      ...
      Serial.println(
        "Wi-Fi recovery failed; restarting ESP-A2 automatically");
      Serial.flush();
      delay(100);
      ESP.restart();
      return;
...
void setup() {
  ...
  Serial.println();
  Serial.println("====================================");
  Serial.println("ARIA ESP-A2 starting");
  Serial.println("====================================");
